    ...
    <section id="about" className="bg-white dark:bg-[#1a1a1a] text-[#111827] dark:text-[#F1F5F9]">
      <div className="mx-auto grid max-w-6xl gap-12 px-4 pt-16 pb-24 md:grid-cols-2 md:items-center">
        <div className="space-y-6">
          ...
          <h2 className="text-4xl font-heading font-bold text-[#111827] dark:text-[#F1F5F9]">Asian Tactical Security Training Pvt Ltd</h2>
          <p className="text-lg leading-relaxed text-[#111827]/90 dark:text-[#F1F5F9]/80">
        ...
        <div className="rounded-2xl border border-[#E5E7EB] dark:border-[#404040] bg-[#F9FAFB] dark:bg-[#2a2a2a] p-8 shadow-sm">
          <h3 className="text-2xl font-heading font-semibold text-[#B8860B]">Core Expertise</h3>
          <ul className="mt-6 space-y-3 text-[#111827] dark:text-[#F1F5F9]">
            {[
