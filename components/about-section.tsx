    ...
    <section id="about" className="bg-white dark:bg-[#1a1a1a]">
      <div className="mx-auto grid max-w-6xl gap-12 px-4 pt-16 pb-24 md:grid-cols-2 md:items-center">
        <div className="space-y-6">
          ...
          <h2 className="text-4xl font-bold text-[#1F2937] dark:text-[#F1F5F9]">Asian Tactical Security Training Pvt Ltd</h2>
          <p className="text-lg leading-relaxed text-[#1F2937]/80 dark:text-[#F1F5F9]/80">
        ...
        <div className="rounded-2xl border border-[#E5E7EB] dark:border-[#404040] bg-[#F9FAFB] dark:bg-[#2a2a2a] p-8 shadow-sm">
          ...
          <ul className="mt-6 space-y-3 text-[#1F2937] dark:text-[#F1F5F9]">
            {[
